<li class="<?php echo $class ?>">
    ...
    <?php else: ?>
      <div class="right"><?php echo link_to('fulfill', sprintf('@%s_fulfill?id='.$resource['id'], $resource['type']), array('confirm' => 'Are you sure?  This can\'t be undone', 'method' => 'POST', 'class' => 'button')) ?></div>      
      <div class="right"><?php echo link_to('delete', sprintf('@%s_delete?id='.$resource['id'], $resource['type']), array('confirm' => 'Are you sure?  This can\'t be undone', 'method' => 'DELETE', 'class' => 'button')) ?></div>
    <?php endif ?>
